...
public partial class SU25_PRN232_SE1725_G4_HIVcareContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AppointmentsThienTttid).HasName("PK__Appointm__DBDAE49919FDB19F");
        ...
        {
            entity.HasKey(e => e.DoctorsPhatNhid).HasName("PK__DoctorPh__E6A309593C080932");
        ...
        {
            entity.HasKey(e => e.UserAccountId).HasName("PK__System.U__DA6C70BA259F52F5");
